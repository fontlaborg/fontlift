...
- macOS listing now uses Core Text font descriptors to return PostScript/family/style/format metadata with scope tagging; `FontInfo` carries optional scope for Rust/Python consumers.
